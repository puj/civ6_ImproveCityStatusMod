...
function OnGameDebugReturn( context, contextTable )
	if context=="RestartGameConfiguration" then
		RestartGame = contextTable["RestartGameConfiguration"];
		if RestartGame ~= nil then
			LuaEvents.GameDebug_AddValue("RestartGameConfiguration","RestartGameConfiguration", nil);
