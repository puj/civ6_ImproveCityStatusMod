...
function Initialize()
	...
	if(CityPopNoWater) then
		for i, row in ipairs(CityPopNoWater) do
			nowatervalue = row.Value;
			break;
		end
	end

	local CoastalWaterBonus:number = coastvalue - nowatervalue;
